...
# ============= ΤΕΛΙΚΟ ΣΩΣΤΟ ΠΛΑΝΟ – ΑΚΡΙΒΩΣ όπως η φωτογραφία σου =============
STALL_POSITIONS = {
    # 5η σειρά (πάνω αριστερά)
    ...
    # 4η σειρά
    "4B1": (2,12), "4B2": (4,12), "4B3": (6,12), "4B4": (8,12), "4B5": (10,12), "4B6": (12,12), "4B7": (14,12), "4B8": (36,12), "4B9": (38,12), "4B10": (40,12), "4B11": (42,12), "4B12": (44,12), "4B13": (46,12), "4B14": (48,12), "4B15": (50,12),
    "4A1": (2,16), "4A2": (4,16), "4A3": (6,16), "4A4": (8,16), "4A5": (10,16), "4A6": (12,16), "4A7": (14,16),

    # 3η σειρά
    "3B1": (2,22), "3B2": (4,22), "3B3": (6,22), "3B4": (8,22), "3B5": (10,22), "3B6": (12,22), "3B7": (14,22), "3B8": (36,22), "3B9": (38,22), "3B10": (40,22), "3B11": (42,22), "3B12": (44,22), "3B13": (46,22), "3B14": (48,22), "3B15": (50,22),
    "3A1": (2,26), "3A2": (4,26), "3A3": (6,26), "3A4": (8,26), "3A5": (10,26), "3A6": (12,26), "3A7": (14,26),

    # 2η σειρά
    "2B1": (2,32), "2B2": (4,32), "2B3": (6,32), "2B4": (8,32), "2B5": (10,32), "2B6": (12,32), "2B7": (14,32), "2B8": (36,32), "2B9": (38,32), "2B10": (40,32), "2B11": (42,32), "2B12": (44,32), "2B13": (46,32), "2B14": (48,32), "2B15": (50,32),
    "2A1": (2,36), "2A2": (4,36), "2A3": (6,36), "2A4": (8,36), "2A5": (10,36), "2A6": (12,36), "2A7": (14,36),

    # 1η σειρά (κάτω δεξιά)
    "1B1": (36,42), "1B2": (38,42), "1B3": (40,42), "1B4": (42,42), "1B5": (44,42), "1B6": (46,42), "1B7": (48,42), "1B8": (50,42), "1B9": (52,42), "1B10": (54,42), "1B11": (56,42), "1B12": (58,42), "1B13": (60,42), "1B14": (62,42), "1B15": (64,42),
    "1A1": (36,46), "1A2": (38,46), "1A3": (40,46), "1A4": (42,46), "1A5": (44,46), "1A6": (46,46), "1A7": (48,46), "1A8": (50,46), "1A9": (52,46), "1A10": (54,46), "1A11": (56,46), "1A12": (58,46), "1A13": (60,46), "1A14": (62,46), "1A15": (64,46)
}
